...
class DWTFunction_3D(Function):
    ...
    def backward(ctx, grad_LLL, grad_LLH, grad_LHL, grad_LHH,
        ...
        type = grad_LLL.dtype
        matrix_Low_0, matrix_Low_1, matrix_Low_2, matrix_High_0, matrix_High_1, matrix_High_2 = \
            matrix_Low_0.to(type), matrix_Low_1.to(type), matrix_Low_2.to(type), matrix_High_0.to(type), matrix_High_1.to(type), matrix_High_2.to(type)
