...
class EMAModel:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs.get("max_value", None) is not None:
            print("The `max_value` argument is deprecated. Please use `decay` instead.")
            decay = kwargs["max_value"]

        if kwargs.get("min_value", None) is not None:
            print("The `min_value` argument is deprecated. Please use `min_decay` instead.")
        ...
        if kwargs.get("device", None) is not None:
            print("The `device` argument is deprecated. Please use `to` instead.")
    ...
    def pin_memory(self) -> None:
        ...
        self.shadow_params = [p.cpu().pin_memory() for p in self.shadow_params]
