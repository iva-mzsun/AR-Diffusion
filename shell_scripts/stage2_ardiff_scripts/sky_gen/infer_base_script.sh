...
VALIDDATA_FILE=$2
MODEL_FILE_NAME=$3
export DATA_CONFIG=configs/skytimelapse/data/${VALIDDATA_FILE}.yaml # fix evaluation dataset
# export MODEL_CONFIG=configs/skytimelapse/ablate/${MODEL_FILE_NAME}.yaml
